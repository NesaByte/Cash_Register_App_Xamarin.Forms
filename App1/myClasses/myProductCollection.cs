...
namespace App1.myClasses
{
    public class myProductCollection
    {
        ...
        //    products.Add(new myProduct() { name = "Shoes", qty = "50", price = "90" });
        //    products.Add(new myProduct() { name = "Hats", qty = "10", price = "20.5" });
        //    products.Add(new myProduct() { name = "Tshirts", qty = "10", price = "10" });
        //    products.Add(new myProduct() { name = "Dresses", qty = "24", price = "10" });
